...
_sherbrooke_q0_sim_config = {
    "kappa": 14.31,
    "chi": 0.335 * 2.0 * jnp.pi,
    "kerr": 0.00,
    "time_coeff": 1.0,
    "snr_coeff": 20.0,
...
def get_sherbrooke_config(qubit: Optional[int] = 0):
    if qubit == 0:
        return copy.deepcopy(_sherbrooke_q0_sim_config)
    if qubit == 1:
        return copy.deepcopy(_sherbrooke_q1_sim_config)
